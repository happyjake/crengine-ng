...
public:
    ...
    CRGUIAcceleratorTableRef get(const lString32& name) {
        return _table.get(name);
    }
    CRGUIAcceleratorTableRef get(const lString32& name, CRPropRef keyRemappingOptions);
    /// find accelerator table by name
    CRGUIAcceleratorTableRef get(const char* name) {
        return _table.get(lString32(name));
    }
...
public:
    CRKeyboardLayout() { }
    const lString32Collection& getItems() {
        return _items;
    }
    lString32 get(int i) {
...
public:
    ...
    CRKeyboardLayoutSet()
            : vKeyboard(new CRKeyboardLayout())
            , tXKeyboard(new CRKeyboardLayout()) {
    }
...
public:
    ...
    CRKeyboardLayoutRef get(lString32 name) {
        return _table.get(name);
    }
    void set(lString32 name, CRKeyboardLayoutRef v) {
        _table.set(name, v);
    }
    CRKeyboardLayoutList()
            : _table(16) { }
    /// reads definitions from files
...
protected:
    ...
    int _param2;
public:
    virtual bool isForVisibleOnly() {
        return false;
    }
    virtual bool isForModalOnly() {
        return false;
    }
    virtual bool isWindowEvent() {
        return _type < CREV_WM_EVENTS_START;
    }
    virtual bool isWMEvent() {
        return _type >= CREV_WM_EVENTS_START;
    }
    int getType() {
        return _type;
    ...
    CRGUIEvent& setParam1(int v) {
        _param1 = v;
        return *this;
    }
    CRGUIEvent& setParam2(int v) {
        _param2 = v;
        return *this;
    }
    CRGUIEvent& setTargetWindow(CRGUIWindow* targetWindow) {
...
public:
    ...
    virtual bool getTurboUpdateEnabled() {
        return false;
    }
    virtual bool getTurboUpdateSupported() {
        return false;
    }
...
public:
    ...
    virtual CRGUIAcceleratorTableRef getAccelerators() {
        return CRGUIAcceleratorTableRef();
    }
...
public:
    ...
    virtual LVRefVec<LVImageSource>& getBatteryIcons() {
        return m_batteryIcons;
    }
    ...
    virtual void setScreenOrientation(cr_rotate_angle_t angle) {
        _orientation = angle;
    }
    /// returns current screen orientation
    virtual cr_rotate_angle_t getScreenOrientation() {
        return _orientation;
    }
    ...
    virtual CRKeyboardLayoutList& getKeyboardLayouts() {
        return _kbLayouts;
    }
    /// returns accelerator table list
    virtual CRGUIAcceleratorTableList& getAccTables() {
        return _accTables;
    }
...
protected:
    ...
    virtual lString32 getStatusText() {
        return _statusText;
    }
...
public:
    /// use to override status text
    virtual void setStatusText(lString32 s) {
        _statusText = s;
    }
    ...
    /// sets scroll label (e.g. "Page $1 of $2" or "$1 / $2")
    virtual void setScrollLabelTemplate(lString32 text) {
        _scrollLabel = text;
    }
    /// returns scroll label (e.g. "$1 of $2")
    virtual lString32 getScrollLabelTemplate() {
        return _scrollLabel;
    }
    /// called on system configuration change: screen size and orientation
    virtual void reconfigure(int flags);
    /// sets skin name for window
    virtual void setSkinName(const lString32& skin) {
        _skinName = skin;
    }
    /// returns skin name for window
    virtual lString32 getSkinName() {
        return _skinName;
    }
    /// returns true if command is processed
    virtual bool onCommand(int command, int params = 0) {
    ...
    virtual CRGUIWindowManager* getWindowManager() {
        return _wm;
    }
...
public:
    ...
    virtual lString32 getPropValue() {
        return _propValue;
    }
    virtual bool isItemDirty() {
        return _itemDirty;
    }
    virtual void setItemDirty() {
        _itemDirty = true;
    }
    virtual void onLeave() {
        CRLog::trace("Menu item %d leave", _id);
        setItemDirty();
    }
    virtual void onEnter() {
        CRLog::trace("Menu item %d enter", _id);
        setItemDirty();
    }
};
...
public:
    ...
    CRMenu(CRGUIWindowManager* wm, CRMenu* parentMenu, int id, lString32 label, LVImageSourceRef image, LVFontRef defFont, LVFontRef valueFont, CRPropRef props = CRPropRef(), const char* propName = NULL, int pageItems = 8)
            ...
            , _props(props)
            , _propName(Utf8ToUnicode(lString8(propName)))
    ...
    LVPtrVector<CRMenuItem>& getItems() {
        return _items;
    }
    CRPropRef getProps() const {
        return _props;
    }
    lString32 getPropName() const {
        return _propName;
    }
    LVFontRef getValueFont() const {
        return _valueFont;
    }
    void setValueFont(LVFontRef font) {
        _valueFont = font;
    }
    void addItem(CRMenuItem* item) {
        _items.add(item);
    }
